    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <a href="<?= base_url('export/toexcelkomputer') ?>" class="btn btn-sm btn-secondary">Export Excel</a>
            </div>
...
<div class="modal fade" id="add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form action="<?= base_url('komputer/save_log') ?>" method="post" id="form-add" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <input type="hidden" name="id_komputer" value="">
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    <label for="">Serial Number</label>
                                </div>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="serial_number" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="type" id="type1_radio" value="LAPTOP" disabled>
                                        <label class="form-check-label" for="type1_radio">LAPTOP</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="type" id="type2_radio" value="DESKTOP" disabled>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="status" id="assetStatus">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(function() {
        ...
        var table = $('#table-data').DataTable({
            ajax: {
                "url": "<?php echo base_url('komputer/show_log'); ?>",
                "type": "GET",
                data:function(data){
        ...
        function format(d) {
            ...
            d.log_user.forEach((item, index) => {
                tr += `<tr>
                            ...
                            <td>${item.status}</td>
                            <td><a href="<?= base_url('file_ba/komputer/') ?>${item.file_ba}" target="_new"><i class="fa-solid fa-file"></i></a></td>
                        </tr>`;
            });
        ...
        $('.table').on('click', '.add-use', function(e) {
            ...
            if (data.log_user.length > 0) {
                let lastuse = data.log_user[0];
                $('#assetStatus').val(lastuse.status)
            } else {
                $('#assetStatus').val('')
            }

            $('[name="id_komputer"]').val(data.id)
