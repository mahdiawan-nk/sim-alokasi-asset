    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <a href="<?= base_url('export/toexcelphone') ?>" class="btn btn-sm btn-secondary">Export Excel</a>
            </div>
...
<div class="modal fade" id="add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form action="<?= base_url('phone/save_log') ?>" method="post" id="form-add" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <input type="hidden" name="id_phone" value="">
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    <label for="">EXT</label>
                                </div>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ext" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="mac_address" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3">
...
<script>
    $(function() {
        ...
        var table = $('#table-data').DataTable({
            ajax: {
                "url": "<?php echo base_url('phone/show_log'); ?>",
                "type": "GET",
                data: function(data) {
        ...
        function format(d) {
            ...
            d.log_user.forEach((item, index) => {
                tr += `<tr>
                            ...
                            <td>${item.status}</td>
                            <td><a href="<?= base_url('file_ba/phone/') ?>${item.file_ba}" target="_new"><i class="fa-solid fa-file"></i></a></td>
                        </tr>`;
            });
